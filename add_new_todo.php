<?php
$link = mysql_connect('localhost','it58160412','it58160412');
mysql_query("SET NAMES UTF8");
mysql_select_db('it58160412',$link);
...
while($obj = mysql_fetch_object($result)){
    ...
    $html3 .= "if($('#".$obj->id."').prop(\"checked\") == true){
                    \$.ajax({url: \"add_new_todo.php\", type: \"POST\", data: \"id=\" + ".$obj->id.", success: function(data) {
                         $(\"#disp\").html(data); 
                     }, 
                    error: function(data) { 
